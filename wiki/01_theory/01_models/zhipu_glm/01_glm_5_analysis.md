...
> 下方 5.1/5.2 表格为发布前估算；论文正式数值（Table 7, p22–24，逐项分析见 [[20_glm5_architecture_deepdive]] 同系列深挖页）如下，差异主要是早期估算偏低：
...
**逐章深挖（机制级，配流程图）**：
- [[20_glm5_architecture_deepdive]] — 架构（MLA·Muon Split·MLA-256·MTP·DSA·高效注意力消融）
- [[21_glm5_data_deepdive]] — 数据（预训练/中训练/长上下文）
- [[22_glm5_training_infra_deepdive]] — 训练基础设施（显存五件套 + 并行）
- [[23_glm5_posttraining_deepdive]] — 后训练（SFT/RL/跨阶段蒸馏）
- [[24_glm5_agentic_rl_deepdive]] — slime + 全异步解耦 RL + 环境扩展
- [[25_glm5_training_stability_deepdive]] — 训练稳定性主线
- [[26_glm5_low_precision_chip_deepdive]] — 低精度链 + 国产芯片
