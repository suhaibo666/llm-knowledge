...
> **机制与 Kernel 深挖（2026-07-17）**: [[20_gdn_kda_linear_attention_analysis]] · [[21_gdn_kda_kernel_implementation_analysis]]
...
> KDA + 3:1 混合架构已在 **Kimi K3**(2.8T,2026-07-16 发布)成为注意力主干,且论文遗留的"MLA 加输出门"在 K3 以 **Gated MLA** 兑现——见 [[22_kimi_k3_architecture_deepdive]] §2-3;KDA 引发的 prefix caching 重做与 FlashKDA kernel 见 [[23_kimi_k3_infra_deepdive]] §3.2-3.3。
...
- [[10_moba_analysis]]
- [[20_gdn_kda_linear_attention_analysis]] — GDN/KDA 的 QKVABZ、RNN 递推与 chunk 数学等价性
- [[21_gdn_kda_kernel_implementation_analysis]] — 训练、Prefill、Decode 融合 kernel
- [[14_kimi_k3_analysis]] / [[22_kimi_k3_architecture_deepdive]] — KDA 在 K3 的产品化落地
