...
- [[10_deepseek_llm_analysis]] — Predecessor dense model (7B/67B) with scaling law studies
- [[12_deepseek_v3_analysis]] — Successor scaling to 671B MoE with FP8 training
- [[13_deepseek_v4_analysis]] — Successor with CSA/HCA hybrid attention replacing MLA, million-token context
- [[14_deepseek_r1_analysis]] — RL-based reasoning model built on DeepSeek-V3-Base
- [[20_deepseek_moe_analysis]] — Detailed MoE architecture analysis
- [[15_deepseek_coder_analysis]] — Code-specific model based on DeepSeek-V2 intermediate checkpoint
- [[16_deepseek_coder_v2_analysis]] — Successor MoE code model (236B) continuing from DeepSeek-V2
- [[17_deepseek_math_analysis]] — DeepSeekMath base model and GRPO algorithm
- [[22_deepseek_prover_analysis]] — Formal theorem proving with GRPO and proof assistant feedback
- [[21_deepseek_vl_analysis]] — Vision-language model built on DeepSeek LLM
- [[18_deepseek_math_v2_analysis]] — Mathematical reasoning with self-verification
- [[25_mhc_analysis]] — Manifold-Constrained Hyper-Connections used in later DeepSeek-V3
- [[14_megatron_ep_analysis]] — Expert parallelism and MoE training infrastructure
