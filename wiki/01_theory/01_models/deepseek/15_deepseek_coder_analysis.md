---
title: "DeepSeek-Coder Analysis"
---

# DeepSeek-Coder Analysis

**Source:** `raw/01_theory/01_models/deepseek/DeepSeek_Coder-2401.14196.md`  
...
- [[16_deepseek_coder_v2_analysis]] — Successor MoE code model with 338 languages and 128K context
- [[11_deepseek_v2_analysis]] — Base architecture (DeepSeek-V2) used for Coder-V2
- [[17_deepseek_math_analysis]] — Math reasoning model trained with similar data pipeline
- [[10_deepseek_llm_analysis]] — Original DeepSeek LLM scaling laws and training framework
- [[20_deepseek_moe_analysis]] — MoE architecture later adopted in Coder-V2
