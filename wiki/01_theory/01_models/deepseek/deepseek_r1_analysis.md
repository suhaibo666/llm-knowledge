...
- [[deepseek_v3_analysis]] — Base model (DeepSeek-V3-Base) and FP8 training infrastructure
- [[deepseek_v2_analysis]] — GRPO algorithm origin and implementation
- [[deepseek_llm_analysis]] — Original DeepSeek scaling law studies
- [[deepseek_math_v2]] — Self-verifiable math reasoning with Generator-Verifier loops
- [[deepseek_coder_analysis]] — Code-specific model lineage
- [[deepseek_coder_v2_analysis]] — MoE code model with GRPO alignment
- [[deepseek_math_analysis]] — GRPO origin and math training pipeline
- [[deepseek_prover_analysis]] — Formal theorem proving with GRPO and RMaxTS
- [[deepseek_vl_analysis]] — Vision-language understanding
- [[mHC]] — Manifold-Constrained Hyper-Connections architecture research
