...
> **阅读导航**：[[24_agentic_rl_algorithm_analysis|上一篇 D03]] · [[01_posttraining_infra_mechanism_analysis|下一篇 D05]]
...
> 本节只覆盖 TIM 与 staleness/off-policy 的关系；kernel 非确定性 → logprob 偏差 → 重要性比方差放大 → 训练崩溃的完整四环因果链见 [[26_tim_causal_chain_analysis]]。
...
- [[02_engineering/04_posttrain_frameworks/12_rl_infra_efficiency_analysis|既有 RL Infra 效率分析]]
