...
| 问题 3（低精度） | [[low_precision_training_analysis]] · [[12_deepseek_v3_analysis]]（FP8 两级累加/DeepGEMM） |
| 问题 1 第 3 层（通信规约树） | [[collectives_analysis]]（ring/tree allreduce）· [[expert_parallel_analysis]]（MoE all-to-all） |
| 问题 9（spike / Muon 系） | [[muon_analysis]] · [[11_kimi_k2_analysis]]（MuonClip）· [[13_deepseek_v4_analysis]] · [[01_glm_5_analysis]] |
