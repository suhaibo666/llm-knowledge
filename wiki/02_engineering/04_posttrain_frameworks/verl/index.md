...
- [[torchtitan/index]] / [[11_torchtitan_fsdp_analysis]] —— FSDP2 `fully_shard` 逐参数分片、`DTensor.full_tensor()`(verl 训练侧重分片的底座)
...
- [[13_torchtitan_cp_analysis]] —— 序列/上下文并行,对照 [[30_verl_optimization_analysis]] 的 Ulysses 序列并行
