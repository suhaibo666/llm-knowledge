...
> 详细的 throughput 数学和 utilization 分析见 [[rl_infra_efficiency_analysis]] 第 3 节。
...
现代设计让三阶段独立排队、独立调度。Phase 3 的方差是 long-tail 杀手，直接驱动 [[rl_infra_efficiency_analysis]] 中的长尾治理手段（redundant rollouts、trajectory-level scheduling、早停、严格 timeout）。
...
- [[03_posttraining/03_agentic_rl_algorithm_analysis]] — Agentic trajectory、reward event、failure 与 coding sandbox schema
...
- [[grpo_analysis]] — GRPO 训练的 rollout 上下文
- [[RL_PPO_Loss_and_GRPO_Analysis]] — PPO / GRPO 的源码级训练流程
