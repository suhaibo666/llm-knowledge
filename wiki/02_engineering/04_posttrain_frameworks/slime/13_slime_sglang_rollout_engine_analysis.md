...
5. **可恢复约束**：engine 故障与请求中断是两个故障域。health monitor 可以杀死并重建 engine；partial rollout 则把已观测到的 Sample 前缀交回 DataSource。两者不能由一个“全局重试”模糊处理。[`health_monitor.py:137-177`](https://github.com/THUDM/slime/blob/681b3adca54105d5ecd3fb822fa0dc58a427e0f9/slime/utils/health_monitor.py#L137-L177) [`sglang_rollout.py:627-649`](https://github.com/THUDM/slime/blob/681b3adca54105d5ecd3fb822fa0dc58a427e0f9/slime/rollout/sglang_rollout.py#L627-L649)
...
普通请求等待最终 JSON，收到后一次性 append。若开启 partial rollout，abort 会从已收敛的 pending tasks 收集含 response 的完整 groups，首次写入 `start_rollout_id`，同步 wrapper 再把它们交给 DataSource buffer。[`sglang_rollout.py:202-219`](https://github.com/THUDM/slime/blob/681b3adca54105d5ecd3fb822fa0dc58a427e0f9/slime/rollout/sglang_rollout.py#L202-L219) [`sglang_rollout.py:351-371`](https://github.com/THUDM/slime/blob/681b3adca54105d5ecd3fb822fa0dc58a427e0f9/slime/rollout/sglang_rollout.py#L351-L371) [`sglang_rollout.py:646-649`](https://github.com/THUDM/slime/blob/681b3adca54105d5ecd3fb822fa0dc58a427e0f9/slime/rollout/sglang_rollout.py#L646-L649)
