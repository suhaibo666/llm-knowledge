...
Megatron combined_1f1b 与 torchtitan ZBV/DualPipeV、MindSpeed fb-overlap+DualPipeV 都在解决"跨 microbatch 打通掩盖"，但路线不同——完整源码级机制见各自权威页（[[20_megatron_comm_overlap_analysis]] §6、[[14_torchtitan_pp_analysis]] §4/§7、[[11_mindspeed_comm_overlap_analysis]] §4.3/§5.1），本节只讲架构差异。
