...
- [[parallelism_orchestration_analysis]] —— Megatron-LM 进程组编排 capstone(RankGenerator、正交分组),与 `ParallelDims` 同类
- [[llm_parallelism_analysis]] —— LLM 正反向计算依赖 DAG 与 TP/SP/EP/CP 通信依赖
