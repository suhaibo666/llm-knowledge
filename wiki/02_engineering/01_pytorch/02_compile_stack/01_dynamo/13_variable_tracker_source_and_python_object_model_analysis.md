---
title: "B05 · VariableTracker、Source 与 Python 对象模型"
---
...
> 前置：[[12_instruction_translator_and_bytecode_state_machine_analysis]]  
> 后续：[[14_output_graph_side_effects_and_graph_emission_analysis]]  
> 最后更新：2026-07-28
...
本页对应卷级入口 `tools/labs_torch_compile/demo_b_dynamo_capture.py` 的 `variable_source_guards` 用例。默认以 CUDA 为验收设备：

```powershell
python -B tools\labs_torch_compile\demo_b_dynamo_capture.py `
  --case variable_source_guards --device cuda `
  --output-dir tools\labs_torch_compile\artifacts\volume_demos\b05
```
