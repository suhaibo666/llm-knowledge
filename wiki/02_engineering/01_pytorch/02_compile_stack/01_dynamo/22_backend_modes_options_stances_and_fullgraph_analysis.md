---
title: "B02 · Backend、Mode、Options、Stance 与 Fullgraph：五个正交控制面"
---
...
> [!note] 已核实:与 [[28_aotinductor_packaging_and_deployment_analysis|AOTInductor 打包与部署]] §2-§3 export 驱动路径的关系(2026-07-30,kb-reorg P4 Task 9 随 F07 迁入一并解答原 todo;同日据 spec 复核修正"runner 对称"表述)
