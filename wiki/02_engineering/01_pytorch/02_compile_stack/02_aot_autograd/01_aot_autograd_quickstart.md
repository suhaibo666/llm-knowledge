...
## 1. 快速导航
> 「AOTAutograd 是什么、在栈中的位置、三大职责(functionalization / joint graph / partition)」见 [[02_engineering/01_pytorch/02_compile_stack/02_aot_autograd/index|AOTAutograd]] 模块概述。本页聚焦上手:下面给出主要入口、核心概念与常用配置的索引,细节落在后续小节。
