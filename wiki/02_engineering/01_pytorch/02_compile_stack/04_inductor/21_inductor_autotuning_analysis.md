---
title: "Inductor Autotuning 与 Triton 编译流程"
---
...
> 填补 [[01_pytorch/index]] 知识空白「Inductor autotuning」。`CoordescTuner`（坐标下降）见本页 §七（2026-07-30 从已删除的 `PyTorch_Inductor_Technical_Analysis.md` §4 判重并入并重新核验）。
