---
title: "PyTorch Inductor Pre-Grad Passes 深度解析"
---
...
> **课程分工**：本页保留阶段清单；当前pass顺序、边界与fixpoint机制见 [[24_graph_pass_pipeline_ordering_and_fixpoint_analysis]]。
...
- [[33_decomposition_passes_guide]] — Pre-Grad 之后的 AOT 算子集收敛
