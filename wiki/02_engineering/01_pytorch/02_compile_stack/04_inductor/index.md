...
> 阅读路径 **overview → quick start → deep dive**(约定见 [[01_pytorch/index]])。本目录为 **upstream**;**NPU Inductor 后端**单独见 [[02_compile_stack/04_inductor/npu/index]]。
