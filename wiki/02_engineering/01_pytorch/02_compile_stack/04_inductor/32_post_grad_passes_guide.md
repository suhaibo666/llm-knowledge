---
title: "PyTorch Inductor Post-Grad Passes 完全解析"
---
...
pass——freezing 等路径按需调用它，与 [[31_joint_graph_passes_guide]] 里只折叠
...
- [[31_joint_graph_passes_guide]] — §4.5 常量折叠的窄化版 `UniformValueConstantFolder`
