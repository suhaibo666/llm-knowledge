---
title: "写一条 ATen 算子:native_functions.yaml 读写速查"
---
...
机制层的「为什么这么设计」(分发表优先级、AST 不变式、boxing/unboxing)在 [[10_aten_codegen_and_structured_kernels_analysis|ATen 算子代码生成与结构化内核]];端到端生命周期总览在 [[02_engineering/01_pytorch/01_eager_runtime/04_aten_op_execution/index|ATen 算子定义与执行]]。
...
- [[02_engineering/01_pytorch/01_eager_runtime/04_aten_op_execution/index|ATen 算子定义与执行]] — 本模块 overview:ATen 算子定义与执行 端到端生命周期
