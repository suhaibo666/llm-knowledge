---
title: "torch_npu 对 PyTorch 的 out-of-tree 适配全景——标准插件面、硬件实现面与兼容补丁面"
---
...
- [[02_compile_stack/04_inductor/index]] —— upstream torch.compile 端到端流水线
- [[10_caching_allocator_autocast_profiler_analysis]] —— allocator、AMP、profiler 的 upstream 通用机制
- [[10_c10d_ddp_fsdp_dtensor_analysis]] —— c10d/ProcessGroup 与上层分布式原语
