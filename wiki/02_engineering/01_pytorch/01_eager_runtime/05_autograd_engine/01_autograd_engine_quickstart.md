...
> 概念全景(Node/Edge/AutogradMeta、与编译期 AOTAutograd 的区别)见 [[02_engineering/01_pytorch/01_eager_runtime/05_autograd_engine/index|Eager 反向自动微分引擎]];源码级深析见 [[10_autograd_engine_analysis]]。
...
- [[02_engineering/01_pytorch/01_eager_runtime/05_autograd_engine/index|Eager 反向自动微分引擎]] — 本模块概述:Node/Edge/AutogradMeta 全景与 DAG 三要素
