---
title: "TensorImpl 与 Storage 源码深析:字段、视图、派发与生命周期"
---
...
派发的完整故事见 [[01_eager_runtime/02_dispatcher_and_device/index]] 与 [[10_pytorch_dispatcher_analysis]];本层只负责给出每个张量的 `key_set_`。
...
- [[02_engineering/01_pytorch/01_eager_runtime/01_tensor_and_storage/index|Tensor 与 Storage]]
