---
title: "PyTorch CUDA Graphs 完整使用指南"
---
...
- [[30_comparison]]
- [[23_vllm_compilation_cudagraph_analysis]] — 生产推理框架的应用实例:vLLM 分段 CUDA Graph(`CUDAGraphWrapper`)、`CudagraphDispatcher` 按形状选图
- [[23_megatron_precision_cudagraph_fusion_analysis]] — 生产训练框架的应用实例:Megatron-LM 三粒度 CUDA Graph(local/transformer_engine/full_iteration)、RNG 状态与 VPP chunk 处理
