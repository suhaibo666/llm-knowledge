...
方法论层面（为什么推理框架比 upstream 多出这三维）见 [[24_graph_pass_pipeline_ordering_and_fixpoint_analysis]] §14；与「fork 骨架却不写融合」的 SGLang 反例对照见 [[sglang_compilation_passes_analysis]]。
...
- [[02_compile_stack/04_inductor/index]] · [[02_compile_stack/01_dynamo/index]] —— Dynamo 抓图 / AOTAutograd 分解与否
- [[21_megatron_fusion_operators_analysis]] · [[23_torchtitan_compute_memory_optimizations_analysis]] —— 训练侧融合算子对照
