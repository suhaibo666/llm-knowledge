...
| 页面 | 来源 | 核心主题 |
|------|------|---------|
| [[gpu_kernel_guide.html]] | 综合深度分析 | 执行层级(Grid/Block/Warp/Thread/SM/Tile)、内存优化(Coalesced/Shared/Tiling/Bank Conflict)、Occupancy、Warp Divergence、异步Pipeline、Tensor Core/MMA、torch.compile 编译路径、FlashAttention 完整链路、NPU 架构差异、诊断清单 |
