...
- [[00_tensor_and_storage/index]] — Parameter/Buffer 是张量子类，理解其底层先看张量与 storage
- [[10_eager_autograd/index]] — `loss.backward()` 填 `.grad`、backward hook 的来龙去脉
- [[03_aot_autograd/index]] — 训练图捕获与函数化，把 nn.functional 的「无状态计算」推到编译期
