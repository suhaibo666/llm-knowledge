...
详见 [[npu_mlir_pipeline_analysis]] 六阶段全景分析。
...
- [[npu_mlir_pipeline_analysis]] — NPU MLIR 六阶段适配全景
- [[NPU_MLIR_Backend_Technical_Analysis]] — TracedGraph 机制、Monkey Patch 清单、编译模式状态机
- [[npu_lowering_guide]] — NPU lowering op 分流策略、NPU 专有 IR 节点
- [[NPU_Inductor_Backend_Analysis]] — 多后端选择与混合使用
- [[NPU_Inductor_Backend_Mechanism]] — MultiTemplateBuffer、Epilogue/Prologue Fusion
