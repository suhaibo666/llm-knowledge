...
- [[joint_graph_passes_guide]] — _sfdp_init 的实现（被 FlexAttention 补充）
- [[pre_grad_passes_guide]] — batch_linear_lhs（QKV 融合的上游 Pass）
- [[triton_vs_mlir_backend_analysis]] — Triton codegen 路径
