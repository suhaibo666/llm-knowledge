...
本页对应卷级入口 `labs/demo_f_advanced_topics.py` 的 `inference_freezing_cudagraph` 用例。默认以 CUDA 为验收设备：
...
python -B wiki\02_engineering\01_ai_frameworks\19_torch_compile_end_to_end\labs\demo_f_advanced_topics.py `
  ...
  --output-dir wiki\02_engineering\01_ai_frameworks\19_torch_compile_end_to_end\labs\artifacts\volume_demos\f08
```
