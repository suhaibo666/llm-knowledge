...
> 前置：[[e02_dynamo_explain_and_graph_break_diagnosis_analysis]]  
> 后续：[[e04_aotautograd_and_inductor_failure_localization_analysis]]  
> 最后更新：2026-07-28
...
本页对应卷级入口 `labs/demo_e_diagnostics.py` 的 `guard_failure` 用例。默认以 CUDA 为验收设备：
...
python -B wiki\02_engineering\01_ai_frameworks\19_torch_compile_end_to_end\labs\demo_e_diagnostics.py `
  ...
  --output-dir wiki\02_engineering\01_ai_frameworks\19_torch_compile_end_to_end\labs\artifacts\volume_demos\e03
```
