...
| 课程页 | cache视角 |
|---|---|
| [[symbolic_shapes_guards_and_graph_reuse_analysis]] | guard定义"同一graph entry何时可复用";PGO影响第一次如何选择dynamic策略 |
| [[aotautograd_joint_forward_backward_graphs_analysis]] | AOT cache hit可能跳过joint/fw/bw的重新构造,但不改变其语义ABI |
