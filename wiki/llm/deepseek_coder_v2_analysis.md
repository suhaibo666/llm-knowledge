...
- [[deepseek_coder_analysis]] — Predecessor dense code model (1.3B-33B)
- [[deepseek_v2_analysis]] — Base MoE architecture (MLA + DeepSeekMoE)
- [[deepseek_math_analysis]] — Math data pipeline and GRPO origin
- [[deepseek_r1_analysis]] — GRPO algorithm used for RL alignment
- [[deepseek_moe_analysis]] — DeepSeekMoE architecture deep dive
