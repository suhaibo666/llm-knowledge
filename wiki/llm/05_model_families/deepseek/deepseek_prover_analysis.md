...
- [[deepseek_math_analysis]] — Base model (DeepSeekMath-Base) and GRPO algorithm origin
- [[deepseek_coder_v2_analysis]] — DeepSeek-Coder-V2 236B used for thought augmentation
- [[deepseek_r1_analysis]] — GRPO extensively used in DeepSeek-R1 pipeline
- [[deepseek_v2_analysis]] — GRPO adopted for general RL alignment
