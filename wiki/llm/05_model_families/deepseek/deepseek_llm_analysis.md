...
- [[deepseek_v2_analysis]] — Successor with MLA attention and MoE architecture
- [[deepseek_v3_analysis]] — Further scaling with FP8 training and expert parallelism
- [[deepseek_r1_analysis]] — RL-based reasoning model built on DeepSeek-V3-Base
- [[deepseek_math_v2]] — Mathematical reasoning specialization
- [[deepseek_coder_analysis]] — Code intelligence specialization
- [[deepseek_coder_v2_analysis]] — MoE code model with 338 languages
- [[deepseek_math_analysis]] — Math reasoning with GRPO origin
- [[deepseek_prover_analysis]] — Formal theorem proving in Lean 4
- [[deepseek_vl_analysis]] — Vision-language model with hybrid encoder
- [[deepseek_moe_analysis]] — MoE architecture details
- [[mHC]] — Manifold-Constrained Hyper-Connections used in DeepSeek-V3 MoE
- [[Engram_Analysis]] — DeepSeek Engram memory mechanism
