...
- [[deepseek_v4_analysis]] — DeepSeek-V4 整体架构分析
- [[deepseek_v4_fp4_qat_analysis]] — FP4 量化感知训练分析
- [[deepseek_v3_analysis]] — V3 的 MLA、FP8 训练、DualPipe
- [[deepseek_v2_analysis]] — MLA 起源（低秩 KV 压缩）、DeepSeekMoE
- [[mHC]] — 流形约束超连接深度解析
- [[deepseek_r1_analysis]] — GRPO 推理训练
- [[llm/06_infra/megatron-lm/Megatron-LM_Distributed_Parallel_Exam]] — Megatron-LM 5D 并行（含标准 CP）
- [[llm/06_infra/megatron-lm/megatron_comm_overlap_analysis]] — 通信重叠分析
