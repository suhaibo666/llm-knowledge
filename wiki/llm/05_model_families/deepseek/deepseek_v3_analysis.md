...
- [[deepseek_v2_analysis]] — Predecessor with MLA and DeepSeekMoE introduction
- [[deepseek_v4_analysis]] — Successor with CSA/HCA hybrid attention, mHC, and Muon optimizer
- [[deepseek_r1_analysis]] — Reasoning model whose capabilities are distilled into V3
- [[deepseek_llm_analysis]] — Original DeepSeek LLM scaling law studies
- [[deepseek_coder_v2_analysis]] — MoE code model based on DeepSeek-V2 architecture
- [[deepseek_math_analysis]] — Math corpus pipeline and GRPO origin
- [[deepseek_prover_analysis]] — Formal theorem proving with Lean 4
- [[deepseek_vl_analysis]] — Vision-language alignment on DeepSeek LLM
