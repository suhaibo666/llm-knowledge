...
- [[deepseek_r1_analysis]] — GRPO used extensively in DeepSeek-R1's multi-stage RL pipeline
- [[deepseek_v2_analysis]] — GRPO adopted for general RL alignment in DeepSeek-V2
- [[deepseek_coder_analysis]] — DeepSeek-Coder-Base-v1.5 is the initialization checkpoint for DeepSeekMath
- [[deepseek_coder_v2_analysis]] — Expanded math corpus (221B tokens) building on DeepSeekMath pipeline
