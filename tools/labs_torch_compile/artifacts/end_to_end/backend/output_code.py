...
cpp_fused_add_sin_sum_view_0 = async_compile.cpp_pybinding(['float*', 'float*'], '''
...
class Runner:
    ...
    def call(self, args):
        ...
        # [Provenance debug handles] cpp_fused_add_sin_sum_view_0:1
        cpp_fused_add_sin_sum_view_0(buf1, buf2)
        return (buf1, buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((4, 4), (4, 1), device='cpu', dtype=torch.float32)
