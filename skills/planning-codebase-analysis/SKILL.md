...
| “The user said ‘continue’ or ‘don’t ask,’ so I can revise ownership myself.” | A generic go-ahead approves only what was presented. Consolidating a mechanism's ownership into one authoritative page is material even when page count and links stay unchanged; present the revised boundary and coverage matrix before writing. |
